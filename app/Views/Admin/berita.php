    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="alert alert-warning" role="alert">
                Untuk Saat ini Data Berita dan Event Tidak Boleh Kosong!!
            </div>
        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Data Event</h4>
                    <p class="mb-0">
                        Event HKBP Beringin Indah
                                    ...
                                    <td> <?php
                                            ...
                                            <div class="modal fade" id="exampleModal<?= $blog->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Aktivisasi Event
                                                                Gereja</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
