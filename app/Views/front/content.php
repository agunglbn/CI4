        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
                    <div class="about-img">
                        <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/about.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/event-birthday.jpg"
                                    class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/event-private.jpg"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/event-custom.jpg"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-1.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-1.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-2.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-2.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-3.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-3.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-4.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-4.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-5.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-5.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-6.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-6.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-7.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-7.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-8.jpg"
                            class="gallery-lightbox" data-gall="gallery-item">
                            <img src="<?php echo base_url(); ?>/assets/vendors/front/assets/img/gallery/gallery-8.jpg"
                                alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
